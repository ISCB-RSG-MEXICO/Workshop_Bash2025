...
**Nota:** Para obtener más detalles sobre cómo instalar y configurar Git Bash, puedes ver este video tutorial: [Instrucciones para instalar Git Bash en Windows](https://www.youtube.com/watch?v=t2-l3WvWvqg).
...
Para instalar **Git**, sigue las instrucciones del [video tutorial](https://www.youtube.com/watch?v=kdM9YOX2hZ0)\
...
1.  Instalar Homebrew (en caso de que no esté instalado)
    ...
    1.  Busca y abre la aplicación de la terminal en tu computadora

    2.  Copia y pega el siguiente código en la terminal y presiona **Enter**

        `/bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/Homebrew/install/HEAD/install.sh)"`

    3.  Presiona **Enter** para comenzar la instalación

    4.  Una vez que acabe la instalación, verifica que la instalación se haya llevado a cabo correctamente con el siguiente código:

        `brew --version`

        Después de presionar **Enter** aparecerá la última versión de **Homebrew** `Homebrew 4.5.7`

2.  Una vez instalado **Homebrew** copia y pega el siguiente codigo en la terminal
