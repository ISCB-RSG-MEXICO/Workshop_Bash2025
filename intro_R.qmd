...
1.  **Source** (arriba a la izquierda): donde escribes y editas código.

2.  **Console** (abajo a la izquierda): donde se ejecutan los comandos.

3.  **Environment / History** (arriba a la derecha): muestra los objetos creados y el historial de comandos.

4.  **Files / Plots / Packages / Help / Viewer** (abajo a la derecha): para explorar resultados, archivos y documentación.
