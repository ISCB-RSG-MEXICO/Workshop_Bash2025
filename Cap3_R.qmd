...
Realiza un código para buscar personajes cuya casa sea Slytherin o Ravenclaw
...
> "Toma hp_data, luego filtra House == Ravenclaw, luego selecciona `Name` y `Blood.status`".
