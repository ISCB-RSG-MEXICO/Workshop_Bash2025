...
-   ::: {.panel-tabset group="globalInfo"}
    ...
    -   Construir y ejecutar scripts en Bash para automatizar tareas básicas.

    -   Integrar buenas prácticas computacionales que favorezcan la organización y reproducibilidad.
    ...
    -   Durante el curso usaremos un servidor, por lo que no es necesario instalar nada.

    -   Opcional: instalación de un enterno Linux como Bash, R y RStudio si deseas descargar y trabajar localmente con los archivos que generemos en el servidor.
