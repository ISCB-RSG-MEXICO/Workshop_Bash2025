...
-   ::: {.panel-tabset group="globalInfo"}
    ...
    -   **Aaron Espinosa Jaime -** Estudiante de doctorado, Cinvestav-LANGEBIO.
    ...
    -   **Dr. Daniel Ochoa Martínez -** COLEGIO DE POSTGRADUADOS. Campus Montecillo.
    -   **Dr. Candelario Ortega Acosta -** COLEGIO DE POSTGRADUADOS. Campus Montecillo.
    -   **M.C. Rodrigo Muñoz Javier -** COLEGIO DE POSTGRADUADOS. Campus Montecillo.
    -   **Jose Abel Lovaco Flores -** RSG-Mèxico.
    ...
    **En R:**
    ...
    Las instrucciones para instalarlos las puedes encontrar en el [capítulo 14](https://iscb-rsg-mexico.github.io/Workshop_Bash2025/install_B.html) para instalación de Bash y [capítulo 15](https://iscb-rsg-mexico.github.io/Workshop_Bash2025/install_R.html) para la instalación de R y Rstudio.
