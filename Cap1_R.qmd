...
Un **data frame** es como una **tabla** de Excel: tiene filas y columnas.
Cada columna puede tener **diferentes tipos de datos** (números, texto, etc.).\
Se crean con `data.frame()`.\
Ejemplo:

```{r}
data.frame(nombre=c("Flores","Mariposas"), cantidad=c(40,25))
```

#### 7. Factores

Se usan para **representar datos categóricos**, como género o colores.\
