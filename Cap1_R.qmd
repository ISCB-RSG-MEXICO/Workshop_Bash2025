...
1.   `3.14159`→ **El número que quieres redondear** (puede ser un solo número o un vector de números).

2.   `2`→ **Cantidad de decimales a mantener** después del punto. Este argumento es opcional; si no lo pones, R redondea al entero más cercano.
...
1.   `7`→ **El número que quieres repetir** (puede ser un solo número o un vector de números).

2.   9 → **Cantidad de veces** que quieres que se reprita el número.

### Funciones útiles y de exploración
...
::: callout-note
2.  Crea un factor con la información del ejemplo y guárdalo en una variable llamada `colores`:
