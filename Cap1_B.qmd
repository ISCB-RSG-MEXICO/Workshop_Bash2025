...
| `tar`           | Empaqueta y comprime directorios | `tar -czf proyecto.tar.gz directorio/` |
...
Cada archivo tiene tres grupos de permisos: usuario (u), grupo (g) y otros (o).
...
|-------------------|-------------------------------------------------------------------|-------------------------------|
| directorio.tar    | `tar -cvf directorio.tar /dir/a/comprimir/directorio`             | `tar -xvf directorio.tar`     |
| directorio.tar.gz | `tar -czvf directorio.tar.gz /directorio/a/empaquetar/directorio` | `tar -zxvf directorio.tar.gz` |
...
2.  Colocate en la directorio donde se encuentra el archivo. Ejemplo en mi computadora: `cd "C:/Users/ecoss/Documents/Respaldos/Github_notes/Workshop_Bash2024/data"`
