...
![](figures/entornoBash.png){fig-align="center" width="1350"}
...
-   Ruta / Camino relativo: indica la ubicación en relación con el directorio actual.
    ...
    ``` {.bash code-copy="true" eval="false"}
    cd ../ # Ir a la directorio anterior
    ```

::: callout-note
**NOTA 1:** Si utilizas `cd` y no indicas una ruta absoluta, te llevara al directorio home (`~`).

**NOTA 2:** Puedes usar la tecla **TAB** para completar el nombre de directorios o archivos. Si hay varias directorios con el mismo inicio, presiona **TAB** dos veces para ver las coincidencias.
:::
...
[![](figures/archivos.png){fig-align="center"}](https://swcarpentry.github.io/shell-novice-es/02-filedir.html)
...
-   Software Carpentry (2023). [La terminal de Unix](https://swcarpentry.github.io/shell-novice-es/02-filedir.html)
-   RSG Ecuador (2020). [GNU/Linux para bioinfomatica](https://rsg-ecuador.github.io/unix.bioinfo.rsgecuador/content/Curso_avanzado/02_Bash/1_bash.html)
-   Harris, R. (2016). [Introduction to the Unix Shell for Transcriptomics Tutorial](https://github.com/raynamharris/Shell_Intro_for_Transcriptomics/tree/master).
