...
Deberías ver `ncbi_seqdata.tar.gz` presente en tu directorio
...
3.  `sed 's/GAA/---/g' > mods_cds.fna`
4.  `sed 's/N//g' X_tropicalis_cds.fna > X_tropicalis_clean.fna`
5.  `sed 's/^>//g' *fna`
:::
:::

## Búsqueda de motivos protéicos en HSPA8

HSPA8 contiene varios motivos funcionales muy característicos:

| Motivo                                        | Secuencia aproximada            | Función                                                         |
|-----------------------------------------------|---------------------------------|-----------------------------------------------------------------|
| **Motivo de unión a ATP (P-loop / Walker A)** | **GxxxxGKST** (ej. "GIDLGTTYS") | Unión e hidrólisis de ATP                                       |
| **Motivo IDLGTT**                             | **IDLGTT**                      | Parte del dominio NBD, importante para cambios conformacionales |
| **Motivo de unión a sustrato**                | **VFTDT** o similares           | Parte del dominio SBD                                           |
| **Motivo EEVD (C-terminal)**                  | **EEVD**                        | Interacción con co-chaperonas y proteínas TPR                   |
| **Motivos ricos en glicina**                  | **GGMPGG**, **GGGA**, etc.      | Región C-terminal flexible reguladora                           |

::: callout-note
## Ejercicio 6

1.  Busca en cada archivo `.faa` cuántas veces aparece el motivo **IDLGTT**
2.  Muestra solo las líneas donde aparece el motivo en `H_sapiens_prot.faa`
3.  Extrae **únicamente** las coincidencias del motivo para todos los organismos (una por línea).
4.  Lista todos los organismos cuya secuencia **termina** con el motivo "EEVD".
5.   Extrae el fragmento completo de la última línea donde aparezca \"EEVD\".
6.   Cuenta cuántas proteínas **carecen** de ese motivo.
